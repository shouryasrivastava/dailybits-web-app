  ...
  return (
    <div className="h-full flex flex-col bg-neutral-50">
      <div className="bg-white border-b border-neutral-200 p-6 min-h-[140px] flex flex-col justify-center">
        <h1 className="text-2xl font-semibold text-neutral-900 mb-2">My Profile</h1>
        <p className="text-neutral-600">View your account details and update your profile</p>
      </div>
