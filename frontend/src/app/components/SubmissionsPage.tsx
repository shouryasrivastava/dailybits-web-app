...
export function SubmissionsPage() {
  ...
  useEffect(() => {
    ...
    fetchSubmissionsApi(ACCOUNT_NUMBER)
      .then(setSubmissions)
      .catch(() => {})
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="border-b border-neutral-200 p-6 min-h-[100px] flex flex-col justify-center">
        <h1 className="text-2xl font-semibold text-neutral-900 mb-3">Submissions</h1>
      ...
      {activeTab === "submissions" ? (
        <div className="flex-1 overflow-y-auto p-6">
          {loadingSubmissions ? (
            <div className="text-center py-12 text-neutral-500">Loading submissions...</div>
          ) : submissions.length === 0 ? (
            <div className="text-center py-12 text-neutral-500">No submissions yet.</div>
          ) : (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-neutral-500">{formatDate(sub.submitted_at)}</p>
                    </div>
                  </div>
      ...
      >
        <DialogContent className="max-w-4xl h-[80vh] flex flex-col">
          <DialogHeader>
            <DialogTitle>
              {selectedSubmission?.problem_title || `Problem #${selectedSubmission?.problem_id}`} — Submission
            </DialogTitle>
          </DialogHeader>
